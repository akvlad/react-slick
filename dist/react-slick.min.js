!(function(e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.Slider = t(require("react"), require("react-dom")))
    : (e.Slider = t(e.React, e.ReactDOM));
})(window, function(e, t) {
  return (
    (i = {}),
    (n.m = r = [
...
*/ !(function() {
      ...
      function(e, t, n) {
        (function(t) {
          ...
          e.exports = function(e, t, r) {
            ...
            function m(e) {
              var n = e - c;
              return void 0 === c || t <= n || n < 0 || (p && s <= e - u);
            }
            function w() {
              var e = n();
              if (m(e)) return S(e);
              l = setTimeout(
                ...
                (function(e) {
                  var n = t - (e - c);
                  return p ? y(n, s - (e - u)) : n;
                })(e)
              );
            }
            function S(e) {
              return (l = void 0), f && i ? g(e) : ((i = o = void 0), a);
            }
            function O() {
              var e = n(),
                r = m(e);
              if (((i = arguments), (o = this), (c = e), r)) {
                if (void 0 === l)
                  return (function(e) {
                    return (u = e), (l = setTimeout(w, t)), d ? g(e) : a;
                  })(c);
                if (p) return (l = setTimeout(w, t)), g(c);
              }
      ...
      function(e, t, n) {
        ...
        (function(e) {
          ...
          var _ = void 0 !== i.ResizeObserver ? i.ResizeObserver : E;
          t.a = _;
        }.call(this, n(4)));
      },
      function(e, t) {
      ...
      function(e, t, n) {
        ...
        function y(e) {
          for (var t = [], n = T(e), r = E(e), i = n; i < r; i++)
        ...
        var T = function(e) {
          ...
          _ = function(e) {
            return e.centerMode
              ? Math.floor(e.slidesToShow / 2) +
                  (0 < parseInt(e.centerPadding) ? 1 : 0)
              : 0;
          },
          j = function(e) {
            return e.centerMode
          ...
          x = function(e) {
            ...
            if (e.swipeToSlide) {
              var n,
                r = s.a.findDOMNode(e.listRef).querySelectorAll(".slick-slide");
              if (
          ...
          D = function(e) {
            return 1 === e.slideCount ? 1 : z(e) + e.slideCount + O(e);
          },
          W = function(e) {
          ...
          R = function(e) {
            ...
            if (n) {
              var o = (t - 1) / 2 + 1;
              return (
                0 < parseInt(i) && (o += 1), r && t % 2 == 0 && (o += 1), o
              );
            }
            return r ? 0 : t - 1;
          },
        ...
        function G(e) {
          ...
          var s = e.isOnSwiping
              ? o === (e.scrolledSlide ? e.scrolledSlide : 0)
              : o === e.currentSlide,
            a = {
              "slick-slide": !0,
              "slick-active": t,
                ...
                value: function() {
                  var e = (function(e) {
                      var t,
                        ...
                        r = [],
                        o = [],
                        s = i.a.Children.count(e.children),
                        a = T(e),
                        l = E(e);
                      return (
                        i.a.Children.forEach(e.children, function(c, u) {
                          var p,
                            f = {
                              message: "children",
                              index: u,
                          ...
                          p =
                            !e.lazyLoad ||
                            (e.lazyLoad && 0 <= e.lazyLoadedList.indexOf(u))
                              ? c
                ...
                value: function() {
                  var e = this,
                    ...
                    o = Array.apply(
                      ...
                      var r = n * e.props.slidesToScroll,
                        ...
                        s = d()({
                          "slick-active":
                            e.props.currentSlide >= r &&
                            e.props.currentSlide <= o
                        }),
                        a = {
                          message: "dots",
                          index: n,
                      ...
                      return i.a.createElement(
                        "li",
                        { key: n, className: s },
                        i.a.cloneElement(e.props.customPaging(n), {
                          onClick: l
                        })
                      );
                    });
                  return i.a.cloneElement(
                    ...
                    (function(e) {
                      ...
                      return e;
                    })({ className: this.props.dotsClass }, r)
                  );
                }
              }
            ]),
        ...
        var fe = (function() {
            function e() {
              return ae(this, e), ue(this, de(e).apply(this, arguments));
            }
            return (
              pe(e, i.a.PureComponent),
              ce(e, [
                {
                  key: "clickHandler",
                  value: function(e, t) {
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    return this.props.prevArrow
                      ? i.a.cloneElement(this.props.prevArrow, oe({}, n, {}, r))
                      : i.a.createElement(
                          "button",
                          re({ key: "0", type: "button" }, n),
                          " ",
                          "Previous"
                        );
                  }
              ...
              ce(e, [
                ...
                },
                {
                  ...
                  value: function() {
                    ...
                    m(this.props) || ((e["slick-disabled"] = !0), (t = null));
                    var n = {
                        key: "1",
                        "data-role": "none",
                        className: d()(e),
                    ...
                    return this.props.nextArrow
                      ? i.a.cloneElement(this.props.nextArrow, oe({}, n, {}, r))
                      : i.a.createElement(
                          "button",
                          re({ key: "1", type: "button" }, n),
                          " ",
                          "Next"
                        );
                  }
        ...
        var Ee = (function() {
              ...
              return (
                ...
                Te(
                  Oe(
                    (n = (function(e, t) {
                      return !t ||
                        ("object" !== ge(t) && "function" != typeof t)
                        ? Oe(e)
                        : t;
                    })(this, Se(e).call(this, t)))
                  ),
                  "listRefHandler",
                  function(e) {
                    return (n.list = e);
                ...
                Te(Oe(n), "trackRefHandler", function(e) {
                  return (n.track = e);
                }),
                Te(Oe(n), "adaptHeight", function() {
                  if (n.props.adaptiveHeight && n.list) {
                    var e = n.list.querySelector(
                      '[data-index="'.concat(n.state.currentSlide, '"]')
                    );
                    n.list.style.height = b(e) + "px";
                  }
                }),
                Te(Oe(n), "componentWillMount", function() {
                  if (
                    (n.ssrInit(),
                    n.props.onInit && n.props.onInit(),
                    n.props.lazyLoad)
                  ) {
                    var e = y(we({}, n.props, {}, n.state));
                    0 < e.length &&
                ...
                Te(Oe(n), "componentDidMount", function() {
                  var e = we({ listRef: n.list, trackRef: n.track }, n.props);
                ...
                Te(Oe(n), "componentWillUnmount", function() {
                ...
                Te(Oe(n), "componentWillReceiveProps", function(e) {
                  for (
                    var t = we(
                  ...
                  n.updateState(t, r, function() {
                    n.state.currentSlide >= i.a.Children.count(e.children) &&
                      n.changeSlide({
                        message: "index",
                        index: i.a.Children.count(e.children) - e.slidesToShow,
                        currentSlide: n.state.currentSlide
                      }),
                      e.autoplay ? n.autoPlay("update") : n.pause("paused");
                  });
                }),
                Te(Oe(n), "componentDidUpdate", function() {
                  if (
                    (n.checkImagesLoad(),
                ...
                Te(Oe(n), "onWindowResized", function(e) {
                ...
                Te(Oe(n), "resizeWindow", function() {
                  var e =
                    !(0 < arguments.length && void 0 !== arguments[0]) ||
                    arguments[0];
                  if (s.a.findDOMNode(n.track)) {
                    var t = we(
                      { listRef: n.list, trackRef: n.track },
                      n.props,
                      {},
                ...
                Te(Oe(n), "updateState", function(e, t, r) {
                  var o = (function(e) {
                    var t,
                      n = i.a.Children.count(e.children),
                      r = Math.ceil(v(s.a.findDOMNode(e.listRef))),
                      o = Math.ceil(v(s.a.findDOMNode(e.trackRef)));
                    if (e.vertical) t = r;
                    else {
                    ...
                    e.rtl &&
                      void 0 === e.currentSlide &&
                      (u = n - 1 - e.initialSlide);
                    var d = e.lazyLoadedList || [],
                      p = y({ currentSlide: u, lazyLoadedList: d });
                    d.concat(p);
                    var f = {
                      slideCount: n,
                      slideWidth: t,
                  ...
                  e = we(
                    {},
                    (e = we({}, e, {}, o, { slideIndex: o.currentSlide })),
                    { left: C(e) }
                  );
                  var a = L(e);
                  (!t &&
                    i.a.Children.count(n.props.children) ===
                      i.a.Children.count(e.children)) ||
                    (o.trackStyle = a),
                    n.setState(o, r);
                }),
                Te(Oe(n), "ssrInit", function() {
                  if (n.props.variableWidth) {
                    ...
                    n.setState({ trackStyle: u });
                  } else {
                    var p = i.a.Children.count(n.props.children),
                      f = we({}, n.props, {}, n.state, { slideCount: p }),
                      h = z(f) + O(f) + p,
                      y = (100 / n.props.slidesToShow) * h,
                      v = 100 / h,
                      b = (-v * (z(f) + n.state.currentSlide) * y) / 100;
                    n.props.centerMode && (b += (100 - (v * y) / 100) / 2);
                    var g = { width: y + "%", left: b + "%" };
                    n.setState({ slideWidth: v + "%", trackStyle: g });
                  }
                }),
                Te(Oe(n), "checkImagesLoad", function() {
                  var e = document.querySelectorAll(".slick-slide img"),
                    t = e.length,
                    r = 0;
                  Array.prototype.forEach.call(e, function(e) {
                    function i() {
                      return ++r && t <= r && n.onWindowResized();
                    }
                    if (e.onclick) {
                      var o = e.onclick;
                      e.onclick = function() {
                ...
                Te(Oe(n), "progressiveLazyLoad", function() {
                  for (
                    var e = [],
                      t = we({}, n.props, {}, n.state),
                      r = n.state.currentSlide;
                    r < n.state.slideCount + O(t);
                    r++
                  )
                  ...
                  for (var i = n.state.currentSlide - 1; i >= -z(t); i--)
                ...
                Te(Oe(n), "slideHandler", function(e) {
                  var t =
                      1 < arguments.length &&
                      void 0 !== arguments[1] &&
                      arguments[1],
                      ...
                      if (r) {
                        ...
                        (v = w) < 0
                          ...
                          : s <= w &&
                            ((v = w - s),
                            i ? s % d != 0 && (v = 0) : (v = s - p)),
                          (b = C(f({}, e, { slideIndex: w }))),
                          (g = C(f({}, e, { slideIndex: v }))),
                          i || (b === g && (w = v), (b = g)),
                          l && a.concat(y(f({}, e, { currentSlide: w }))),
                          h
                            ? (O = {
                                animating: !(S = {
                                  animating: !0,
                                  currentSlide: v,
                                  trackStyle: M(f({}, e, { left: b })),
                                  lazyLoadedList: a
                                }),
                                currentSlide: v,
                                trackStyle: L(f({}, e, { left: g })),
                                swipeLeft: null
                              })
                            : (S = {
                                currentSlide: v,
                ...
                Te(Oe(n), "changeSlide", function(e) {
                  var t =
                      1 < arguments.length &&
                      void 0 !== arguments[1] &&
                      arguments[1],
                    r = (function(e, t) {
                      ...
                      if (
                        ...
                        if (d) {
                          var p = W(f({}, e, { targetSlide: o }));
                          o > t.currentSlide && "left" === p
                            ? (o -= l)
                            : o < t.currentSlide && "right" === p && (o += l);
                        }
                      } else if (
                        "index" === t.message &&
                        ...
                        return null;
                      return o;
                    })(we({}, n.props, {}, n.state), e);
                  (0 !== r && !r) ||
                    (!0 === t ? n.slideHandler(r, t) : n.slideHandler(r));
                }),
                Te(Oe(n), "clickHandler", function(e) {
                  !1 === n.clickable &&
                    (e.stopPropagation(), e.preventDefault()),
                    (n.clickable = !0);
                }),
                Te(Oe(n), "keyHandler", function(e) {
                ...
                Te(Oe(n), "selectHandler", function(e) {
                  n.changeSlide(e);
                }),
                Te(Oe(n), "disableBodyScroll", function() {
                ...
                Te(Oe(n), "enableBodyScroll", function() {
                  window.ontouchmove = null;
                }),
                Te(Oe(n), "swipeStart", function(e) {
                ...
                Te(Oe(n), "swipeMove", function(e) {
                  var t = (function(e, t) {
                    ...
                    if (!n) {
                      ...
                      if (!s && !h && 10 < j) return { scrolling: !0 };
                      s && (w.swipeLength = j);
                      var P = (a ? -1 : 1) * (w.curX > w.startX ? 1 : -1);
                      s && (P = w.curY > w.startY ? 1 : -1);
                      var M = Math.ceil(y / v),
                        z = g(t.touchObject, s),
                        D = w.swipeLength;
                      b ||
                        ...
                        (T = i
                          ...
                          : _ + D * P),
                        s && (T = _ + D * P);
                      var W = l + ("left" === z || "up" === z ? 1 : -1) * x(t);
                      return (
                        (E = f({}, E, {
                          touchObject: w,
                          swipeLeft: T,
                          trackStyle: L(f({}, t, { left: T })),
                          scrolledSlide: W,
                          isOnSwiping: !0
                        })),
                ...
                Te(Oe(n), "swipeEnd", function(e) {
                  var t = (function(e, t) {
                    ...
                    if (i.swipeLength > v) {
                      var w, S;
                      switch ((e.preventDefault(), p && p(b), b)) {
                        case "left":
                        case "up":
                          (S = y ? h : c + x(t)),
                            (w = u ? P(t, S) : S),
                ...
                Te(Oe(n), "play", function() {
                  var e;
                  if (n.props.rtl)
                    e = n.state.currentSlide - n.props.slidesToScroll;
                  else {
                    if (!m(we({}, n.props, {}, n.state))) return !1;
                    e = n.state.currentSlide + n.props.slidesToScroll;
                  }
                  n.slideHandler(e);
                }),
                Te(Oe(n), "autoPlay", function(e) {
                  n.autoplayTimer && clearInterval(n.autoplayTimer);
                ...
                Te(Oe(n), "onDotsOver", function() {
                  return n.props.autoplay && n.pause("hovered");
                }),
                Te(Oe(n), "onDotsLeave", function() {
                  return (
                    n.props.autoplay &&
                ...
                Te(Oe(n), "onTrackOver", function() {
                  return n.props.autoplay && n.pause("hovered");
                }),
                Te(Oe(n), "onTrackLeave", function() {
                  return (
                    n.props.autoplay &&
                    "hovered" === n.state.autoplaying &&
                    n.autoPlay("leave")
                ...
                Te(Oe(n), "onSlideFocus", function() {
                  return n.props.autoplay && n.pause("focused");
                }),
                Te(Oe(n), "onSlideBlur", function() {
                  return (
                    n.props.autoplay &&
                ...
                Te(Oe(n), "render", function() {
                  var e,
                    t,
                    r,
                    o = d()("slick-slider", n.props.className, {
                      "slick-vertical": n.props.vertical,
                      "slick-initialized": !0
                    }),
                    s = we({}, n.props, {}, n.state),
                    a = w(s, [
                      "fade",
                      "cssEase",
                      "speed",
                  ...
                  if (
                    ((a = we({}, a, {
                      ...
                      focusOnSelect: n.props.focusOnSelect
                        ? n.selectHandler
                        : null,
                      scrolledSlide: n.state.scrolledSlide
                        ? n.state.scrolledSlide
                        : null,
                      isOnSwiping: n.state.isOnSwiping
                    })),
                    !0 === n.props.dots &&
                    ...
                    var c = w(s, [
                      ...
                      u = n.props.pauseOnDotsHover;
                    (c = we({}, c, {
                      clickHandler: n.changeSlide,
                      onMouseEnter: u ? n.onDotsLeave : null,
                      onMouseOver: u ? n.onDotsOver : null,
                      onMouseLeave: u ? n.onDotsLeave : null
                    })),
                      (e = i.a.createElement(te, c));
                  }
                  var p = w(s, [
                    "infinite",
                    "centerMode",
                  ...
                  (p.clickHandler = n.changeSlide),
                    n.props.arrows &&
                      ((t = i.a.createElement(fe, p)),
                      (r = i.a.createElement(he, p)));
                  var f = null;
                  ...
                  var y = we({}, f, {}, h),
                    ...
                    b = {
                      ...
                      onMouseDown: v ? n.swipeStart : null,
                      onMouseMove: n.state.dragging && v ? n.swipeMove : null,
                      onMouseUp: v ? n.swipeEnd : null,
                      onMouseLeave: n.state.dragging && v ? n.swipeEnd : null,
                      onTouchStart: v ? n.swipeStart : null,
                      onTouchMove: n.state.dragging && v ? n.swipeMove : null,
                      onTouchEnd: v ? n.swipeEnd : null,
                      onTouchCancel: n.state.dragging && v ? n.swipeEnd : null,
                      onKeyDown: n.props.accessibility ? n.keyHandler : null
                    },
                    g = { className: o, dir: "ltr" };
                  return (
                    n.props.unslick &&
                    ...
                    i.a.createElement(
                      ...
                      i.a.createElement(
                        "div",
                        ve({ ref: n.listRefHandler }, b),
                        i.a.createElement(
                          V,
                          ve({ ref: n.trackRefHandler }, a),
                          n.props.children
                        )
                      ),
                      n.props.unslick ? "" : r,
                ...
                (n.state = we({}, a, {
                  ...
                  slideCount: i.a.Children.count(n.props.children)
                })),
                (n.callbackTimers = []),
                (n.clickable = !0),
          ...
          Pe = {
            ...
            customPaging: function(e) {
              return i.a.createElement("button", null, e + 1);
            },
            dots: !1,
              ...
              return (
                ...
                He(
                  We(
                    (n = (function(e, t) {
                      return !t ||
                        ("object" !== xe(t) && "function" != typeof t)
                        ? We(e)
                        : t;
                    })(this, De(e).call(this, t)))
                  ),
                ...
                He(We(n), "slickPrev", function() {
                  return n.innerSlider.slickPrev();
                }),
                He(We(n), "slickNext", function() {
                  return n.innerSlider.slickNext();
                }),
                He(We(n), "slickGoTo", function(e) {
                  var t =
                    1 < arguments.length &&
                    void 0 !== arguments[1] &&
                    arguments[1];
                ...
                He(We(n), "slickPause", function() {
                  return n.innerSlider.pause("paused");
                }),
                He(We(n), "slickPlay", function() {
                    ...
                    if (this.props.responsive) {
                      ...
                      t.sort(function(e, t) {
                        ...
                        t.forEach(function(n, r) {
                          ...
                          (i =
                            0 === r
                              ? je()({ minWidth: 0, maxWidth: n })
                              : je()({ minWidth: t[r - 1] + 1, maxWidth: n })),
                            k() &&
                              e.media(i, function() {
                                e.setState({ breakpoint: n });
                              });
                        });
                      var n = je()({ minWidth: t.slice(-1)[0] });
                      k() &&
                ...
                },
                {
                  ...
                  value: function() {
                    this._responsiveMediaHandlers.forEach(function(e) {
                      Ie.unregister(e.query, e.handler);
                    });
                  }
                },
                {
                  ...
                  value: function() {
                    ...
                    (e = this.state.breakpoint
                      ? "unslick" ===
                        ...
                        ? "unslick"
                        : Ce({}, Pe, {}, this.props, {}, t[0].settings)
                      : Ce({}, Pe, {}, this.props)).centerMode &&
                      ...
                      e.fade &&
                        ...
                        (e.slidesToShow = 1),
                        (e.slidesToScroll = 1));
                    var r = i.a.Children.toArray(this.props.children);
                    (r = r.filter(function(e) {
                      return "string" == typeof e ? !!e.trim() : !!e;
                    })),
                      e.variableWidth &&
                        (1 < e.rows || 1 < e.slidesPerRow) &&
                        (console.warn(
                    ...
                    for (
                      ...
                      for (
                        ...
                        for (
                          ...
                          (e.variableWidth &&
                            r[d].props.style &&
                            (s = r[d].props.style.width),
                          !(d >= r.length));
                          d += 1
                        )
                          u.push(
                            i.a.cloneElement(r[d], {
                              key: 100 * a + 10 * c + d,
                              tabIndex: -1,
                              style: {
                        ...
                        l.push(
                          i.a.createElement("div", { key: 10 * a + c }, u)
                        );
                      }
                      e.variableWidth
                        ? o.push(
                        ...
                        : o.push(i.a.createElement("div", { key: a }, l));
                    }
                    if ("unslick" !== e)
                      return (
                        ...
                        i.a.createElement(
                          Ee,
                          Le({ ref: this.innerSliderRefHandler }, e),
                          o
                        )
                      );
                    var p = "regular slider " + (this.props.className || "");
                    return i.a.createElement("div", { className: p }, o);
                  }
                }
              ]),
              e
