                ...
                Te(Oe(n), "swipeMove", function(e) {
                  var t = (function(e, t) {
                    ...
                    if (!n) {
                      ...
                      if (!s && !h && 10 < P) return { scrolling: !0 };
                      s && (w.swipeLength = P);
                      var M = (a ? -1 : 1) * (w.curX > w.startX ? 1 : -1);
                      ...
                      var R = s ? O / T : k / T,
                        H =
                          w.swipeLength > R
                            ? l + ("left" === D || "up" === D ? 1 : -1) * x(t)
                            : l;
                      return (
                        (_ = f({}, _, {
                          touchObject: w,
                          swipeLeft: E,
                          trackStyle: L(f({}, t, { left: E })),
                          scrolledSlide: H,
                          isOnSwiping: !0
                        })),
